...
knob_selection_input_path = f"../../data/bo_result/ablation_study/{args.logfile}"
workload = args.logfile[:-4]
output_path = f"../../data/bo_result/{workload}_conf_new.json"
...
if match:
    ...
    try:
        ...
        print("설정값이 'knobs_config.json' 파일로 저장되었습니다.")
